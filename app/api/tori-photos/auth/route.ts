...
import {
  TORI_PHOTOS_AUTH_COOKIE,
  TORI_PHOTOS_AUTH_MAX_AGE_SECONDS,
  isAuthedRequest,
  issueToken,
  verifyPasscode,
} from "@/lib/toriPhotosAuth";
...
export async function POST(request: NextRequest) {
  ...
  res.cookies.set(TORI_PHOTOS_AUTH_COOKIE, issueToken(), {
    httpOnly: true,
    sameSite: "lax",
    maxAge: TORI_PHOTOS_AUTH_MAX_AGE_SECONDS,
    path: "/",
  });
  return res;
}
