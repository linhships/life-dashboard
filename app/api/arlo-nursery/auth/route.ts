...
import {
  ARLO_NURSERY_PHOTOS_AUTH_COOKIE,
  ARLO_NURSERY_PHOTOS_AUTH_MAX_AGE_SECONDS,
  isAuthedRequest,
  isGateEnabled,
  issueToken,
  verifyPasscode,
} from "@/lib/arloNurseryPhotosAuth";
...
export async function POST(request: NextRequest) {
  ...
  res.cookies.set(ARLO_NURSERY_PHOTOS_AUTH_COOKIE, issueToken(), {
    httpOnly: true,
    sameSite: "lax",
    maxAge: ARLO_NURSERY_PHOTOS_AUTH_MAX_AGE_SECONDS,
    path: "/",
  });
  return res;
}
