    ...
    <main className="mx-auto max-w-6xl space-y-8 px-6 py-10">
      <header>
        <div className="flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>
            {days.length} days · {totalPhotos} photos
          </span>
        </div>
        <h1 className="mt-1 text-2xl font-bold text-slate-900">Tori & the boys</h1>
        <p className="mt-2 text-sm text-slate-500">
          Every photo Tori sent while looking after Milo and Arlo, from her first day to her
          last — pulled from your WhatsApp chats with her and grouped by the day she took them.
        </p>
      </header>
